...
const TEXT = {
  es: {
    title: "Owners",
    subtitle:
      "Listado de propietarios importados. Buscar, filtrar por país, fuente y estado.",
    back: "Volver",
    import: "Importar owner",
    search: "Buscar owner",
    country: "País",
    source: "Fuente",
    status: "Estado",
    ...
    countryColumn: "País",
    horses: "Caballos",
    noItems: "Todavía no hay owners cargados.",
  },
  pt: {
    title: "Owners",
    subtitle:
      "Lista de proprietários importados. Buscar, filtrar por país, fonte e estado.",
    back: "Voltar",
    import: "Importar owner",
    search: "Buscar owner",
    country: "País",
    ...
    countryColumn: "País",
    horses: "Cavalos",
    noItems: "Ainda não há owners carregados.",
  },
  en: {
    title: "Owners",
    subtitle:
      "Imported owners list. Search, filter by country, source and status.",
    back: "Back",
    import: "Import owner",
    search: "Search owner",
    country: "Country",
...
export default function OwnersAdminPage() {
  ...
  return (
    <AdminListLayout
      ...
      importHref="/paneladmin/blood-races/owners/importar"
    ...
    >
      <Table
        empty={t.noItems}
        items={filtered}
        headers={[t.name, t.countryColumn, t.horses, t.source]}
        renderRow={(item) => (
          <>
