...
const TEXT = {
  es: {
    title: "Jockeys",
    subtitle:
      "Listado de jockeys importados. Buscar, filtrar por país, fuente y estado.",
    back: "Volver",
    import: "Importar jockey",
    search: "Buscar jockey",
    country: "País",
    source: "Fuente",
    status: "Estado",
    all: "Todos",
    ...
    totalRaces: "Carreras",
    wins: "Ganadas",
    noItems: "Todavía no hay jockeys cargados.",
  },
  pt: {
    title: "Jóqueis",
    subtitle:
      "Lista de jóqueis importados. Buscar, filtrar por país, fonte e estado.",
    back: "Voltar",
    import: "Importar jóquei",
    search: "Buscar jóquei",
    country: "País",
    source: "Fonte",
    status: "Estado",
    all: "Todos",
    ...
    totalRaces: "Corridas",
    wins: "Vitórias",
    noItems: "Ainda não há jóqueis carregados.",
  },
  en: {
    title: "Jockeys",
    subtitle:
      "Imported jockeys list. Search, filter by country, source and status.",
    back: "Back",
    import: "Import jockey",
    search: "Search jockey",
    country: "Country",
    source: "Source",
    status: "Status",
    all: "All",
    ...
    totalRaces: "Races",
    wins: "Wins",
    noItems: "No jockeys loaded yet.",
  },
};

const DEMO_DATA = [];

export default function JockeysAdminPage() {
  ...
  return (
    <AdminListLayout
      ...
      importHref="/paneladmin/blood-races/jockeys/importar"
    ...
    >
      <Table
        empty={t.noItems}
        items={filtered}
        headers={[t.name, t.country, t.nationality, t.totalRaces, t.wins, t.source]}
        renderRow={(item) => (
          <>
